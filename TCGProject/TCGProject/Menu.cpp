...
Title.Buffer[0] = (char*)"===============================================================";
Title.Buffer[1] = (char*)"Ⅱ                           ,,                              Ⅱ";
Title.Buffer[2] = (char*)"Ⅱ   .g8'''bgd             `7MM                              Ⅱ";
Title.Buffer[3] = (char*)"Ⅱ .dP'     `M               MM                              Ⅱ";
Title.Buffer[4] = (char*)"Ⅱ dM'       ` ,6'Yb.,   M''bMM `7MM  `7MM  `7Mb,od8.gP'Ya   Ⅱ";
Title.Buffer[5] = (char*)"Ⅱ MM         8)   MM ,AP    MM   MM    MM    MM' '',M'   Yb Ⅱ";
Title.Buffer[6] = (char*)"Ⅱ MM.         ,pm9MM 8MI    MM   MM    MM    MM    8M'''''' Ⅱ";
Title.Buffer[7] = (char*)"Ⅱ `Mb.     ,'8M   MM `Mb    MM   MM    MM    MM    YM.    , Ⅱ";
Title.Buffer[8] = (char*)"Ⅱ   `'bmmmd' `Moo9^Yo.`Wbmd'MML. `Mbod'YML..JMML.   `Mbmmd' Ⅱ";
Title.Buffer[9] = (char*)"===============================================================";
